...
Wakefield's study concluded that there was a causal relationship between vaccination for measles, mumps, and rubella (MMR) and autism [@criver]. In this paper, a small sample size of 12 children consisting of all but one girl was employed [@wakefield]. This appears to limit the ability to which the findings of the research can be extrapolated to the overall human population.
